    ...
    <header className="sticky top-0 px-6 py-4 bg-white border-b border-theme-gray-200">
      <div className="flex justify-between">
        ...
        <div className="flex gap-4">
          <div>
            <button className="p-3 border rounded-lg size-11 border-theme-gray-200">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
        ...
        <div className="flex items-center gap-4 ">
          <div className="flex gap-3">
            <button className="inline-flex items-center justify-center border rounded-full border-theme-gray-200 size-11">
              <svg
                className="size-5"
                width="20"
                height="20"
            ...
            <button className="relative inline-flex items-center justify-center border rounded-full border-theme-gray-200 size-11">
              <svg
                className="size-5"
                width="20"
                height="20"
