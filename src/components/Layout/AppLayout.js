...
export default function AppLayout({ children }) {
  ...
  return (
    <div className="min-h-screen xl:flex">
            ...
            <div className="">
              ...
              <nav className="pt-4">
                <ul>
                  <li>
                    <button
                      className="flex items-center w-full gap-3 px-3 py-2 text-sm font-medium transition rounded-lg hover:bg-primary-100 text-secondary-300"
      ...
      <div
        className={`flex-1 ${
          isSidebarOpen ? "xl:ml-[290px]" : ""
        }  bg-theme-gray-300 dark:bg-gray-900`}
      >
        <AppHeader onClick={handleSidebar} />
