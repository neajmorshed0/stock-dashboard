    ...
    <Card>
      ...
      <div>
        <Swiper {...swiperOptions}>
          <SwiperSlide>
            <div className="p-5 rounded-2xl dark:bg-gray-900 bg-theme-gray-500">
              <div className="flex justify-between pb-5 border-b dark:border-gray-700 border-theme-gray-200">
                ...
                <div>
                  <h2 className="text-sm font-medium dark:text-white text-secondary-300">
                    $192.53
                  </h2>
            ...
            <div className="p-5 rounded-2xl dark:bg-gray-900 bg-theme-gray-500">
              <div className="flex justify-between pb-5 border-b dark:border-gray-700 border-theme-gray-200">
                ...
                <div>
                  ...
                  <span className="flex items-center gap-1 text-xs font-medium text-error-500">
                    <svg
                      className="size-3"
                      width="12"
                      height="12"
